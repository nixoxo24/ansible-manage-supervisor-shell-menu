...
function select_site_option_clark() {
  ...
  read SITE_SELECT
    ...
    1)
      ...
      ansible-playbook -i inventory supervisor_restart.yaml --limit datacenter # ansible command to restart all servers
  ...
  case $SPECIFIC_CLARK in
    1)
      ...
      ansible-playbook -i inventory supervisor_restart.yaml --limit issuerse_bancnet1_clark
  
    ;;

    2)
      echo "Bancnet-2" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit issuerse_bancnet2_clark
      
    ;;

    3)
      echo "Visa-1" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit issuerse_visa1_clark

    ;;

    4)
      echo "Visa-2" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit issuerse_visa2_clark
    ;;

    5)
      echo "Smartpay-1" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit issuerse_smartpay1_clark
    ;;
    6)
      echo "Smartpay-2" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit issuerse_smartpay2_clark
    ;;
    7)
      echo "Card id-1" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit cardidse1_clark
    ;;
    8)
      echo "Card id-2" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit cardidse2_clark 

    ;;
    9)
      echo "Key exchange-1" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit key_exchange1_clark 
    ;;
    10)
      echo "Key exchange-2" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit  key_exchange2_clark 
    ;;
    11)
      echo "EFS Personalization-1" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit efs1_personalization_clark
    ;;
    12)
      echo "EFS Personalization-2" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit efs2_personalization_clark
    ;;
    13)
      echo "Pin verification-1" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit pin_verificationse1_clark
    ;;
    14)
      echo "Pin verification-2" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit pin_verificationse2_clark
    ;;
    15)
      echo "EFS Wrapper-1" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit efs_wrapper1_clark
    ;;
    16)
      echo "EFS Wrapper-2" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit efs_wrapper2_clark
    ;;
    17)
      echo "EFS Wrapper-3" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit efs_wrapper3_clark
    ;;
    18)
      echo "EFS Wrapper-4" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit efs_wrapper4_clark
    ;;
    19)
      echo "EFS Portal-1" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit efs_portal1_wrapper_clark
    ;;
    20)
      echo "EFS Portal-2" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit efs_portal2_wrapper_clark
    ;;
    21)
      echo "Bus Portal-1" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit busportalese1_clark
    ;;
    22)
      echo "Bus Portal-2" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit busportalese2_clark
    ;;
    23)
      echo "SFTP" | tee -a $SCRIPT_LOG_FILE
      ansible-playbook -i inventory supervisor_restart.yaml --limit sftp_clark
    ;;
